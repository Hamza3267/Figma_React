...
const Card = ({cardmainsetting}) => {
  ...
  const slideTransform = `translateX(-${currentSlide * (3700 / totalSlides)}px)`; 
  return (
    <>
    <div className={style.maincontent}>
      <div className={`${style.main} ${cardmainsetting}`} style={{ transform: slideTransform }}>
